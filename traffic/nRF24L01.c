...
uchar const RX_ADDRESS[RX_ADR_WIDTH]  = {0x34,0x43,0x10,0x10,0x01}; 
uchar const RX_ADDRESS1[RX_ADR_WIDTH]  = {0xb0,0xb2,0xb3,0xb4,0x01}; 
 int H;
...
void SetRX_Mode(void)
{
	...
	SPI_Write_Buf(WRITE_REG + RX_ADDR_P1, RX_ADDRESS1, RX_ADR_WIDTH); // Use the same address on the RX device as the TX device
